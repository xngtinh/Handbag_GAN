...
for i_batch in range(0, n_images, im_batch_size):
    ...
    for i_image in range(gen_images.size(0)):
        save_image(gen_images[i_image, :, :, :], os.path.join('./generator/static/generator/images/clutch', f'{i_image+1}.png'))
...
def images(request):
    path = './generator/static/generator/images/clutch/'  # insert the path to your directory
    img_list = []
    img_list = os.listdir(path)
    del img_list[0]
    return render(request,  'generator/images.html', {'title':'Clutch', 'category':'clutch', 'images': img_list })
